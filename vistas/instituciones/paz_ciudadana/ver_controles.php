<!-- PESTAÑA VER CONTROLES DE JEFE ZONA PAZ CIUDADANA -->
<?php
...
async function generarPDF() {
    ...
    const imgData = await getBase64ImageFromURL('/SIPC/estaticos/img/paz_ciudadana.jpg');
