<!-- PESTAÑA REGISTRAR DELITO ADMIN PAZ CIUDADANA -->
...
<head>
	...
	body {
		...
		.btn-secondary {
			background-color:rgb(210, 212, 38);
			color: white;
			font-weight: bold;
			border: none;
			display: block;
...
<div class="container">
    ...
    <form action="../../../../controladores/guardar_delito_pc.php" method="POST" enctype="multipart/form-data">
