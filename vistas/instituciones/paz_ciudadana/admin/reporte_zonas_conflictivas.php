<!-- PESTAÑA REPORTE ZONAS CONFLICTIVAS DE PAZ CIUDADANA -->
...
th {
    background-color: #C0C0C0; /* Verde oscuro */
...
td {
    background-color: #D3D3D3; /* Fondo verde claro */
