...
<div class="container mt-5">
    ...
    <form action="../../../../controladores/guardar_control_pdi_op.php" method="POST" class="bg-white p-4 rounded shadow">
	...
	?>
		...
		<div class="mb-3">
			...
			<select id="id_institucion" name="id_institucion" class="form-select" required>
				<option value="5" selected>Policia de Investigaciones de Chile</option>
			</select>
		</div>
