<!-- PESTAÑA ELIMINAR USUARIO DE ADMIN CARABINEROS -->
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["rut_eliminar"])) {
    ...
    if ($resultado->num_rows > 0) {
        ...
        if ($usuario["rol"] === "AdministradorGeneral" || $usuario["rol"] === "JefeZona") {
            $mensaje = "No se puede eliminar a un usuario con rol de Administrador General o Jefe Zona.";
        } else {
