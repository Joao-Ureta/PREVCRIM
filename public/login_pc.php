    ...
    if (empty($correo) || empty($contrasena)) {
        ...
        if ($result->num_rows > 0) {
            ...
            if (password_verify($contrasena, $usuario['contrasena'])) {
                ...
                $institucion_carabineros = 3; // Asegúrate de que este ID corresponde a "Paz ciudadana"

                switch ($_SESSION['rol']) {
                    case 'AdministradorGeneral':
                        if ($_SESSION['id_institucion'] == $institucion_carabineros) {
                            header('Location: http://localhost/SIPC/vistas/instituciones/admin_general.php');
                            exit();
                        } else {
                    ...
                    case 'JefeZona':
                        ...
                        exit();
                    case 'Operador':
                        header('Location: http://localhost/SIPC/vistas/instituciones/paz_ciudadana/operador.php');
                        exit();
                    default:
