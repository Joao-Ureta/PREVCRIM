<!-- CONTROLADOR INGRESAR USUARIO PDI -->
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['nombre_completo'], $_POST['rut'], $_POST['correo'], $_POST['contrasena'], $_POST['rol'])) {
        ...
        if ($stmt->execute()) {
            echo "<script>alert('$rol registrado exitosamente'); window.location.href='../vistas/instituciones/pdi/ingresar_usuario.php';</script>";
        } else {
    ...
    echo "<script>alert('Acceso inválido'); window.location.href='../vistas/instituciones/pdi/ingresar_usuario.php';</script>";
}
?>
