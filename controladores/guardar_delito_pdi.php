<!-- CONTROLADOR GUARDAR DELITO ADMIN PDI -->
...
if ($stmt->execute()) {
    ...
    echo "<script>alert('Delito registrado exitosamente'); window.location.href='../vistas/instituciones/pdi/admin/form_registrar_delito.php';</script>";
    exit;
} else {
    // En caso de error, redirigir con mensaje de error
    echo "<script>alert('Error al registrar el delito'); window.location.href='../vistas/instituciones/pdi/admin/form_registrar_delito.php';</script>";
    exit;
}
