<!-- CONTROLADOR INGRESAR USUARIO ADMIN PAZ CIUDADANA -->
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['nombre_completo'], $_POST['rut'], $_POST['correo'], $_POST['contrasena'], $_POST['rol'])) {
        ...
        // id_institucion fijo para Paz Ciudadana
        $id_institucion = 3;
        ...
        if ($stmt->execute()) {
            echo "<script>alert('Usuario registrado exitosamente'); window.location.href='../vistas/instituciones/paz_ciudadana/admin/ingresar_usuario.php';</script>";
        } else {
    ...
    echo "<script>alert('Acceso inválido'); window.location.href='../vistas/instituciones/paz_ciudadana/admin/ingresar_usuario.php';</script>";
}
?>
